...
5a. Rows "kf", "dp", and "ds" can be added to the "Compound List" and will manually override the mass transfer coefficients. If you set their value to 0 or omit them, they will be recalculated automatically.  
